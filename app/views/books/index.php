<div class="container">
	...
	<div class="card d-flex flex-row flex-wrap justify-content-center" style="margin-bottom: 100px;">
		...
		<?php foreach ($data['buku'] as $b): ?>
			...
			<!-- <div class="mt-2 mb-2 shadow  bg-body-tertiary rounded"
													style="width: 15vw; margin-left: 1vw; margin-right: 1vw;">
			...
			<button type="button" class="btn btn-primary mb-1" data-bs-toggle="modal" data-bs-target="#modal-detail"
				id="detail" data-idbuku="<?= $b['id_buku']; ?>" data-iduser="<?= $b['id_user']; ?>"
				data-judul="<?= $b['judul']; ?>" data-harga="<?= $b['harga']; ?>" data-no="<?= $b['no_telp']; ?>"
				data-deskripsi="<?= $b['deskripsi']; ?>" data-cover="<?= $b['cover']; ?>" data-nama="<?= $b['nama']; ?>"
				data-bukufav="<?= $id_bf; ?>">
				Lihat Detail..
			</button>
						...
						<div class="col-md-10">
							<div class="row p-2 bg-white border rounded">
								...
								<div class="col-md-6 mt-1">
									...
									<a href="<?= BASEURL; ?>/books/author/<?= $b['id_user']; ?>"
								...
								<div class="align-items-center align-content-center col-md-3 border-left mt-1">
									...
									<div class="d-flex flex-column mt-4">
										<button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
											data-bs-target="#modal-detail" id="detail" data-idbuku="<?= $b['id_buku']; ?>"
