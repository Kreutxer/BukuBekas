...
<div class="container d-flex">
	<h1 class="mx-4">Buku Favoritemu :
		<?= $data['user']['nama']; ?>
	</h1><br>
	<hr>
	<div class="card flex-row flex-wrap justify-content-center" style="margin-bottom: 100px; width: 70vw;">
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button class="btn btn-outline-danger" id="hapus-fav">
					<a href="" style="text-decoration: none; color:black;text-shadow: 1px 1px 1px 1px;">Hapus Dari
						Favorite</a>
				</button>
			</div>
		</div>
